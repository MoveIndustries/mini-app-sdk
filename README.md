# @movement-network/miniapp-sdk

Official SDK for building Movement Mini Apps that run inside the Movement Everything Mobile App.

## Installation

Since this package is not yet published to npm, install directly from GitHub:

```bash
npm install github:MoveIndustries/mini-app-sdk
```
...
{
  "dependencies": {
    "@movement-network/miniapp-sdk": "github:MoveIndustries/mini-app-sdk"
  }
}
```
...
```javascript
import { getMovementSDK } from '@movement-network/miniapp-sdk';
...
```typescript
import { useMovementSDK } from '@movement-network/miniapp-sdk';
...
import type {
  ...
  UserInfo,
  PopupOptions
} from '@movement-network/miniapp-sdk';
```
